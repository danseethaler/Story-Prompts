...
import {TopicColorsType} from 'wStyled';
import {CardType, TopicKeys, TopicType} from 'wTypes';

export const categories: {
  [key in TopicKeys]: TopicType;
} = {
  emotional: {
    key: 'emotional',
    title: 'Emotional',
...
export const topicColors = _.reduce(
  categories,
  (prev, topic, key) => ({...prev, [key]: topic.color}),
  {},
) as TopicColorsType;

export const topicColorsLight = _.reduce(
  categories,
  (prev, topic, key) => ({...prev, [key]: topic.colorLight}),
  {},
) as TopicColorsType;

export const topicColorsCenter = _.reduce(
  categories,
